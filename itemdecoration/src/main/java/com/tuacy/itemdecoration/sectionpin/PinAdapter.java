...
public class PinAdapter extends SectionPinAdapter<RecyclerView.ViewHolder> {
	...
	public PinAdapter(List<String> dataList) {
		mDataList = dataList;
	}
	...
	public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		if (viewType == VIEW_TYPE_ITEM_TIME) {
			return new TitleHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adapter_title, parent, false));
		} else {
			return new ContentHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adapter_content, parent, false));
		}
	}
