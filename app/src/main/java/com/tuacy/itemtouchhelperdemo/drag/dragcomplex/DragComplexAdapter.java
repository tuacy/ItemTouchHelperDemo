...
public class DragComplexAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public DragComplexAdapter() {
		this(null);
	}

	public DragComplexAdapter(List<String> dataList) {
		mDataList = dataList;
	}
