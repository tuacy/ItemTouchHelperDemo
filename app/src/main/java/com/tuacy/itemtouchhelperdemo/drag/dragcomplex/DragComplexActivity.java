package com.tuacy.itemtouchhelperdemo.drag.dragcomplex;
...
public class DragComplexActivity extends AppCompatActivity {

	public static void startUp(Context context) {
		context.startActivity(new Intent(context, DragComplexActivity.class));
	}

	private RecyclerView       mRecyclerView;
	private Context            mContext;
	private DragComplexAdapter mAdapter;
	...
	private void initView() {
		...
		ItemTouchHelper touchHelper = new ItemTouchHelper(new DragCallback(mDragHelper));
	...
	private void initData() {
		mAdapter = new DragComplexAdapter(obtainData());
